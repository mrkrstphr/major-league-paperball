...
function Base({ filled, color }: { filled: boolean; color: string }) {
  return (
    <div
      style={{
        width: 20,
...
export default function Bases({ runners, color = 'black' }: Props) {
  return (
