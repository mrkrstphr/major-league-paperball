...
export function CircleClosed({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 14 14" shapeRendering="crispEdges" fill="black">
      ...
      <rect x="7" y="5" width="1" height="1"></rect>
      <rect x="8" y="5" width="1" height="1"></rect>
      ...
      <rect x="4" y="7" width="1" height="1"></rect>
      <rect x="5" y="7" width="1" height="1"></rect>
      <rect x="6" y="7" width="1" height="1"></rect>
      ...
      <rect x="13" y="7" width="1" height="1"></rect>
